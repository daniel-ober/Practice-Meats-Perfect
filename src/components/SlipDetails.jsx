...
const weightedAppearance = ((appearance) * (0.150).toFixed(2))
const weightedTaste = ((taste) * (0.5).toFixed(2))
const weightedTenderness = ((tenderness) * (0.350).toFixed(2))
const weightedTotal = ((weightedAppearance + weightedTaste + weightedTenderness)).toFixed(2)
